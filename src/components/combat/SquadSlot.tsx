        ...
        animate={
          isDead
            ...
            ? {
                ...
                y: [0, (activeAttackVector?.y || (isDesktop ? 0 : -350)) * -0.2, activeAttackVector?.y || (isDesktop ? 0 : -350)],
                scale: [1, 0.95, 1.2],
                rotate: [0, -5, 10],
        ...
        <div className="absolute bottom-0 left-0 w-full p-1.5 flex flex-col gap-1">
          ...
          <div className="flex gap-2">
            ...
            <div className="w-10 flex flex-col justify-end items-end gap-1">
              ...
              <div className="text-[7px] text-zinc-300 font-mono text-right bg-black/40 px-1 rounded border border-white/5 whitespace-nowrap">
                  {getCardRole(card).toUpperCase()}
              </div>
            </div>
          </div>
        </div>
