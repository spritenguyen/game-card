                    ...
                    >
                        ...
                        <div className="p-5 border-b border-white/5 bg-gradient-to-r from-zinc-900 to-black">
                            <h3 className="text-lg font-serif text-white mb-1 tracking-tight flex items-center gap-2">
                                <Icon name="fa-camera-retro text-cinematic-cyan" className="fa-camera-retro text-cinematic-cyan" /> Giao Thức Reshoot
                            </h3>
                        ...
                        <div className="p-4 flex-1 max-h-[60vh] overflow-y-auto no-scrollbar grid grid-cols-1 gap-2">
                            {IMAGE_MODELS.map((model) => (
                                ...
                                >
                                    ...
                                    <Icon name="fa-chevron-right text-[10px] text-zinc-700 group-hover:text-cinematic-cyan transition-colors" className="fa-chevron-right text-[10px] text-zinc-700 group-hover:text-cinematic-cyan transition-colors" />
                                </button>
                            ))}
                        </div>
