                            ...
                            <section className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="bg-white/5 p-3 rounded-lg border border-white/10">
                                        <h5 className="text-[11px] font-bold text-cinematic-gold mb-1 font-mono uppercase"><Icon name="fa-radar mr-1" className="fa-radar mr-1" /> 1. Trích xuất (Extract)</h5>
                                    ...
                                    <div className="bg-white/5 p-3 rounded-lg border border-white/10">
                                        <h5 className="text-[11px] font-bold text-cinematic-cyan mb-1 font-mono uppercase"><Icon name="fa-dna mr-1" className="fa-dna mr-1" /> 2. Thu dọn & Dung hợp</h5>
                                    ...
                                    <div className="bg-white/5 p-3 rounded-lg border border-white/10">
                                        <h5 className="text-[11px] font-bold text-red-400 mb-1 font-mono uppercase"><Icon name="fa-crosshairs mr-1" className="fa-crosshairs mr-1" /> 3. Tác chiến (Combat)</h5>
                                    ...
                                    <div className="bg-white/5 p-3 rounded-lg border border-white/10">
                                        <h5 className="text-[11px] font-bold text-purple-400 mb-1 font-mono uppercase"><Icon name="fa-shop mr-1" className="fa-shop mr-1" /> 4. Ủy thác & Chợ Đen</h5>
