...
export const Toast: React.FC<{ message: string, type: 'error' | 'success', onClose: () => void }> = ({ message, type, onClose }) => {
    ...
    return (
        <div className={`fixed top-20 left-1/2 transform -translate-x-1/2 z-[70] w-[90%] max-w-2xl p-4 rounded-xl text-center text-sm transition-all duration-300 shadow-lg animate-slide-up
