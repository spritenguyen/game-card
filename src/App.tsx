...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-cinematic-950 overflow-hidden flex flex-col sm:flex-row font-sans selection:bg-cinematic-cyan/30 selection:text-white relative text-gray-200">
      ...
      {selectorTarget && (
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-2 sm:p-6 lg:p-12">
          <div
            className="absolute inset-0 bg-cinematic-950/90 backdrop-blur-2xl"
      ...
      {showSettings && (
        <div className="fixed inset-0 z-[95] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-cinematic-950/80 backdrop-blur-xl" onClick={() => setShowSettings(false)}></div>
