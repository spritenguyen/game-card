                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        {quests.length === 0 && (
                            <div className="col-span-full py-20 flex flex-col items-center justify-center text-center bg-black/40 rounded-3xl border border-white/5 border-dashed shadow-inner">
                                 <i className="fa-solid fa-list-check text-5xl text-zinc-700 w-24 h-24 bg-zinc-900 rounded-full flex items-center justify-center border border-white/5 mb-6 ring-1 ring-white/5 shadow-inner"></i>
                ...
                {subTab === 'expeditions' && (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        {expeditions.length === 0 && (
                            <div className="col-span-full py-20 flex flex-col items-center justify-center text-center bg-black/40 rounded-3xl border border-white/5 border-dashed shadow-inner">
                                 <i className="fa-solid fa-map-location-dot text-5xl text-zinc-700 w-24 h-24 bg-zinc-900 rounded-full flex items-center justify-center border border-white/5 mb-6 ring-1 ring-white/5 shadow-inner"></i>
