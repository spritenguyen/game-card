        ...
        <div className="w-full max-w-7xl mx-auto animate-fade-in pb-24 px-4 sm:px-6">
            <div className="flex flex-col gap-6 bg-zinc-950/80 rounded-3xl border border-cinematic-gold/20 ring-1 ring-cinematic-gold/10 p-6 sm:p-8 mb-8 backdrop-blur-xl shadow-[inset_0_0_100px_rgba(0,0,0,0.8),0_0_40px_rgba(255,184,0,0.05)] relative mt-8 overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-cinematic-gold/10 pb-6 relative z-10">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-cinematic-gold/10 flex items-center justify-center border border-cinematic-gold/30 shadow-[0_0_20px_rgba(255,184,0,0.2)]">
                            <Icon name="fa-vault text-cinematic-gold text-2xl animate-pulse" className="fa-vault text-cinematic-gold text-2xl animate-pulse" />
                        </div>
                        <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5 text-[10px] sm:text-xs font-mono tracking-widest uppercase relative z-10">
                    <div className="flex flex-col gap-2 relative">
                        ...
                        <label className="text-zinc-500 pl-3 flex items-center gap-2 drop-shadow-md"><Icon name="fa-arrow-down-wide-short text-zinc-600" className="fa-arrow-down-wide-short text-zinc-600" /> Sort By</label>
                    ...
                    <div className="flex flex-col gap-2 relative">
                        <div className="absolute left-0 top-6 bottom-0 w-[2px] bg-cinematic-gold/20"></div>
                        <label className="text-zinc-500 pl-3 flex items-center gap-2 drop-shadow-md"><Icon name="fa-star text-zinc-600" className="fa-star text-zinc-600" /> Rank Filter</label>
                        <div className="relative pl-3">
                            <select 
                                value={filterClass} 
                    ...
                    <div className="flex flex-col gap-2 relative">
                        <div className="absolute left-0 top-6 bottom-0 w-[2px] bg-cinematic-gold/20"></div>
                        <label className="text-zinc-500 pl-3 flex items-center gap-2 drop-shadow-md"><Icon name="fa-dna text-zinc-600" className="fa-dna text-zinc-600" /> Faction Filter</label>
                        <div className="relative pl-3">
                            <select 
                                value={filterFaction} 
                            ...
                            >
                                ...
                                <option value="CyberCore" className="bg-zinc-900 text-white">CyberCore</option>
                                <option value="Ethereal" className="bg-zinc-900 text-white">Ethereal</option>
                                <option value="VoidBringer" className="bg-zinc-900 text-white">VoidBringer</option>
                                <option value="MechaMutant" className="bg-zinc-900 text-white">MechaMutant</option>
                                <option value="AstroNomad" className="bg-zinc-900 text-white">AstroNomad</option>
                                <option value="ArcaneWeaver" className="bg-zinc-900 text-white">ArcaneWeaver</option>
                            </select>
                            <Icon name="fa-caret-down absolute right-4 top-1/2 transform -translate-y-1/2 text-zinc-600 pointer-events-none" className="fa-caret-down absolute right-4 top-1/2 transform -translate-y-1/2 text-zinc-600 pointer-events-none" />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 relative">
                         <div className="absolute left-0 top-6 bottom-0 w-[2px] bg-cinematic-gold/20"></div>
                        <label className="text-zinc-500 pl-3 flex items-center gap-2 drop-shadow-md"><Icon name="fa-fire text-zinc-600" className="fa-fire text-zinc-600" /> Element Filter</label>
                        <div className="relative pl-3">
                            <select 
                                value={filterElement} 
            ...
            {filteredAndSortedCards.length === 0 ? (
                <div className="py-24 flex flex-col items-center justify-center text-zinc-600 border border-white/5 bg-zinc-950/50 rounded-3xl border-dashed">
                    <Icon name="fa-box-open text-5xl mb-6 opacity-30" className="fa-box-open text-5xl mb-6 opacity-30" />
