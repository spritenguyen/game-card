                    ...
                    <div className="bg-cinematic-900/40 border border-white/5 rounded-3xl p-6 sm:p-10 shadow-[inset_0_0_80px_rgba(0,0,0,0.5),0_0_40px_rgba(0,243,255,0.05)] relative backdrop-blur-md ring-1 ring-white/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
                            <div className="space-y-4">
                                <h4 className="text-cinematic-gold text-[10px] sm:text-xs font-mono uppercase border-b border-cinematic-gold/20 pb-2 tracking-[0.2em] flex items-center gap-2"><Icon name="fa-cart-shopping" className="fa-cart-shopping" /> Purchase Order</h4>
                            ...
                            <div className="space-y-4">
                                <h4 className="text-purple-400 text-[10px] sm:text-xs font-mono uppercase border-b border-purple-500/20 pb-2 tracking-[0.2em] flex items-center gap-2"><Icon name="fa-atom" className="fa-atom" /> Quantum Release (Sell)</h4>
                             ...
                             <div className="space-y-5">
                                 <div>
                                     ...
                                     <div className="relative">
                                         ...
                                         <Icon name="fa-caret-down absolute right-4 top-1/2 transform -translate-y-1/2 text-zinc-500" className="fa-caret-down absolute right-4 top-1/2 transform -translate-y-1/2 text-zinc-500" />
                                     </div>
                                 </div>
                             ...
                             <div className="flex items-center justify-center sm:border-l border-white/5 sm:pl-10 mt-6 sm:mt-0 pt-6 sm:pt-0 border-t sm:border-t-0">
                                 {selectedCardId ? (
                                    <div className="text-center w-full bg-black/40 p-8 rounded-2xl border border-white/5 relative overflow-hidden">
                                        <div className="absolute top-0 right-0 p-4 opacity-5"><Icon name="fa-microscope text-6xl" className="fa-microscope text-6xl" /></div>
                                     ...
                                     <div className="text-zinc-800 font-mono text-center flex flex-col items-center justify-center gap-4 w-full h-[300px] border border-white/5 border-dashed rounded-2xl bg-black/30">
                                         <Icon name="fa-dna text-5xl opacity-50 mb-2" className="fa-dna text-5xl opacity-50 mb-2" />
