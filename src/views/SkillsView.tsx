      ...
      <div className="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-cinematic-cardBg border border-white/5 p-6 rounded-xl">
        <div>
          <h1 className="text-3xl font-serif text-white tracking-wider flex items-center gap-3">
            <Icon name="fa-dna" className="text-cinematic-cyan" /> Bio-Enhancements
          </h1>
          <p className="text-white/60 mt-1">Upgrade your squad's overall combat efficiency. Passives apply to all units.</p>
        </div>
        <div className="flex bg-black/40 border border-white/10 rounded-lg p-3 px-6 text-center">
            ...
            <div className="flex flex-col">
                <span className="text-xs text-white/50 uppercase tracking-widest">Available SP</span>
                            ...
                            >
                                <div className="flex justify-between items-start">
                                   ...
                                   {unlocked ? (
                                       ...
                                       <span className="text-[10px] uppercase font-mono text-white/40">{node.cost} SP</span>
                                   )}
                                </div>
                                <div>
